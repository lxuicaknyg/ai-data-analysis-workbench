...
export const naiveThemeConfigs: Record<string, ThemeConfig> = {
  ...
  cebb: {
    ...
    themeOverrides: {
      common: {
        primaryColor: '#a973c1',
        primaryColorHover: '#9a64ad',
        primaryColorPressed: '#8b569b',
        primaryColorSuppl: '#c9a8d9',
        successColor: '#059669',
        successColorHover: '#047857',
        successColorPressed: '#065f46',
        successColorSuppl: '#dcfce7',
        ...
        popoverColor: '#ffffff',
        tableColor: '#f5f5f5',
        hoverColor: 'rgba(169, 115, 193, 0.08)',
        ...
        borderColor: '#e5e5e5',
        dividerColor: '#f0f0f0',
        scrollbarColor: 'rgba(169, 115, 193, 0.3)',
        scrollbarColorHover: 'rgba(169, 115, 193, 0.5)',
        closeIconColor: 'rgba(169, 115, 193, 0.6)',
        closeIconColorHover: '#a973c1',
        closeIconColorPressed: '#8b569b',
        clearColor: 'rgba(169, 115, 193, 0.2)',
        clearColorHover: 'rgba(169, 115, 193, 0.3)',
        clearColorPressed: 'rgba(169, 115, 193, 0.4)'
      },
      Button: {
        textColorPrimary: '#ffffff',
        textColorHoverPrimary: '#ffffff',
        ...
        textColorDisabledPrimary: 'rgba(255, 255, 255, 0.6)',
        colorPrimary: '#a973c1',
        colorHoverPrimary: '#9a64ad',
        colorPressedPrimary: '#8b569b',
        colorFocusPrimary: '#a973c1',
        colorDisabledPrimary: '#c9a8d9',
        borderPrimary: '1px solid #a973c1',
        borderHoverPrimary: '1px solid #9a64ad',
        borderPressedPrimary: '1px solid #8b569b',
        borderFocusPrimary: '1px solid #a973c1',
        borderDisabledPrimary: '1px solid #dcc8e6',
        rippleColorPrimary: 'rgba(169, 115, 193, 0.3)',
        textColor: '#a973c1',
        textColorHover: '#8b569b',
        textColorPressed: '#7a478b',
        color: '#f5f5f5',
        colorHover: '#eeeeee',
        colorPressed: '#e5e5e5',
        border: '1px solid #dcc8e6',
        borderHover: '1px solid #c9a8d9',
        borderPressed: '1px solid #b694c6'
      },
      Input: {
        color: '#ffffff',
        ...
        colorFocus: '#ffffff',
        textColor: '#333333',
        textColorDisabled: 'rgba(51, 51, 51, 0.5)',
        placeholderColor: '#cccccc',
        placeholderColorDisabled: 'rgba(204, 204, 204, 0.6)',
        iconColor: '#cccccc',
        iconColorHover: '#a973c1',
        iconColorPressed: '#8b569b',
        iconColorDisabled: 'rgba(204, 204, 204, 0.5)',
        clearColor: 'rgba(169, 115, 193, 0.2)',
        clearColorHover: 'rgba(169, 115, 193, 0.3)',
        clearColorPressed: 'rgba(169, 115, 193, 0.4)',
        border: '1px solid #e5e5e5',
        borderDisabled: '1px solid rgba(229, 229, 229, 0.6)',
        borderHover: '1px solid #c9a8d9',
        borderFocus: '1px solid #a973c1',
        boxShadowFocus: '0 0 0 2px rgba(169, 115, 193, 0.15)',
        caretColor: '#a973c1',
        suffixTextColor: '#666666',
        prefixTextColor: '#666666'
      },
      Card: {
        color: '#ffffff',
        colorModal: '#ffffff',
      ...
      Tabs: {
        tabColor: '#f5f5f5',
        tabColorActive: '#a973c1',
        tabBorderColor: '#e5e5e5',
        tabTextColorBar: '#a973c1',
        tabTextColorBarHover: '#8b569b',
        tabTextColorBarActive: '#ffffff',
        tabTextColorCard: '#666666',
        tabTextColorCardActive: '#333333',
        barColor: '#a973c1'
      },
      Radio: {
        buttonBorderColor: '#e5e5e5',
        buttonBorderColorActive: '#a973c1',
        buttonColor: '#f5f5f5',
        buttonColorActive: '#f0e6f5',
        buttonTextColor: '#666666',
        buttonTextColorActive: '#a973c1'
      },
      Dropdown: {
        color: '#ffffff',
        optionTextColor: '#333333',
        optionTextColorHover: '#333333',
        optionTextColorActive: '#ffffff',
        optionColorHover: '#f5f5f5',
        optionColorActive: '#a973c1',
        borderColor: '#e5e5e5'
      }
    }
  },
